...
def last_hope(f,
              ...
              h_1, f_1, T_1,phi_1,
              h_2, f_2, T_2,phi_2,
              h_high, f_high, T_high,phi_high, **kwargs):
    ...
    signal = (_lh_func(f,h_peak,f_peak,T_peak,phi_peak)+
...
def easter_half_reparam(
    time,
    h_peak, h_1, h_2,
    logT_peak, logT_1, logT_2,
    f_peak, f_1, f_2,
    a_peak, a_1, a_2,
    psi_peak, psi_1, psi_2,
    t0, **kwargs
):
